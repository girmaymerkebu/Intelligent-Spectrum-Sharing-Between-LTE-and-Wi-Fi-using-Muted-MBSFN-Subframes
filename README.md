...
```
cd existing_repo
git remote add origin https://gitlab.ilabt.imec.be/mgirmay/adaptive-mbsfn.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.ilabt.imec.be/mgirmay/adaptive-mbsfn/-/settings/integrations)
...
>>>>>>> 03bf1dcf123de813e57d6ac9b6d42df66435ee6f
