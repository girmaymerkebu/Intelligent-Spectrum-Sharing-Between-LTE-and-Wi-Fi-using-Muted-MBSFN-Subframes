...
public:
  ...
  virtual void     configure_mbsfn_sibs(int sfalloc, int sfperiod)  =0; //interface between RRC and MAC to enable periodic resource configuration 

 virtual uint32_t generate_sibs(int sfalloc, int sfperiod)    =0; ////interface between RRC and MAC to enable periodic SIB generation 
};
